...
type
  TfrmRelFornecedoras = class(TForm)
...
procedure TfrmRelFornecedoras.btnGerarMouseEnter(Sender: TObject);
Var
uUtils : utils;
begin
  uUtils := utils.Create;
...
procedure TfrmRelFornecedoras.btnGerarMouseLeave(Sender: TObject);
Var
uUtils : utils;
begin
  uUtils := utils.Create;
...
procedure TfrmRelFornecedoras.Text8MouseEnter(Sender: TObject);
Var
uUtils : utils;
begin
  uUtils := utils.Create;
...
procedure TfrmRelFornecedoras.Text8MouseLeave(Sender: TObject);
Var
uUtils : utils;
begin
  uUtils := utils.Create;
